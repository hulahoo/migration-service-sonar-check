...
CREATE INDEX IF NOT EXISTS ix_stat_received_object_ioc_type ON stat_checked_objects (ioc_type);
...
DROP INDEX IF EXISTS ix_stat_received_object_indicator_id ON stat_received_objects (indicator_id);
DROP INDEX IF EXISTS ix_stat_checked_object_indicator_id ON stat_checked_objects (indicator_id);
